...
"background-color: white;")
        ...
        self.verticalLayout = QVBoxLayout(self.tabChat)
        ...
        sizePolicy.setHeightForWidth(self.ChatBody.sizePolicy().hasHeightForWidth())
        self.ChatBody.setSizePolicy(sizePolicy)
        ...
        self.ChatBodyContents.setObjectName(u"ChatBodyContents")
        self.ChatBodyContents.setFrameShape(QFrame.StyledPanel)
        self.ChatBodyContents.setFrameShadow(QFrame.Raised)

        self.verticalLayout_3.addWidget(self.ChatBodyContents)

        self.ChatBody.setWidget(self.scrollAreaWidgetContents)

        self.verticalLayout.addWidget(self.ChatBody)
